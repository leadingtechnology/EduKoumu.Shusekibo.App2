...
class AttendanceTimedStatusModelAdapter
    extends TypeAdapter<_$AttendanceTimedStatusModelImpl> {
  @override
  final int typeId = 27;

  @override
  _$AttendanceTimedStatusModelImpl read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return _$AttendanceTimedStatusModelImpl(
  ...
  @override
  void write(BinaryWriter writer, _$AttendanceTimedStatusModelImpl obj) {
    writer
      ..writeByte(8)
      ..writeByte(0)
      ..write(obj.jokyoDate)
  ...
  bool operator ==(Object other) =>
      ...
      other is AttendanceTimedStatusModelAdapter &&
...
_$AttendanceTimedStatusModelImpl _$$AttendanceTimedStatusModelImplFromJson(
...
Map<String, dynamic> _$$AttendanceTimedStatusModelImplToJson(
        _$AttendanceTimedStatusModelImpl instance) =>
    <String, dynamic>{
